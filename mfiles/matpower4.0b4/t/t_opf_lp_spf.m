...
%   MATPOWER
%   $Id: t_opf_lp_spf.m,v 1.14 2010/04/26 19:45:26 ray Exp $
...
mpopt = mpoption('OUT_ALL', 0, 'VERBOSE', verbose, 'OPF_ALG', 360);
% mpopt = mpoption(mpopt, 'OPF_VIOLATION', 1e-7, 'CONSTR_TOL_X', 1e-7, 'CONSTR_TOL_F', 1e-7);
